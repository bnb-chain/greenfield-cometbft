...
func (_m *MockAppConnConsensus) PrepareProposalSync(_a0 types.RequestPrepareProposal) (*types.ResponsePrepareProposal, error) {
	ret := _m.Called(_a0)
...
// MockAppConnConsensus_PrepareProposalSync_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PrepareProposalSync'
type MockAppConnConsensus_PrepareProposalSync_Call struct {
	*mock.Call
}

// PrepareProposalSync is a helper method to define mock.On call
//   - _a0 types.RequestPrepareProposal
func (_e *MockAppConnConsensus_Expecter) PrepareProposalSync(_a0 interface{}) *MockAppConnConsensus_PrepareProposalSync_Call {
	return &MockAppConnConsensus_PrepareProposalSync_Call{Call: _e.mock.On("PrepareProposalSync", _a0)}
}

func (_c *MockAppConnConsensus_PrepareProposalSync_Call) Run(run func(_a0 types.RequestPrepareProposal)) *MockAppConnConsensus_PrepareProposalSync_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockAppConnConsensus_PrepareProposalSync_Call) Return(_a0 *types.ResponsePrepareProposal, _a1 error) *MockAppConnConsensus_PrepareProposalSync_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAppConnConsensus_PrepareProposalSync_Call) RunAndReturn(run func(types.RequestPrepareProposal) (*types.ResponsePrepareProposal, error)) *MockAppConnConsensus_PrepareProposalSync_Call {
	_c.Call.Return(run)
	return _c
}

// ProcessProposalSync provides a mock function with given fields: _a0
func (_m *MockAppConnConsensus) ProcessProposalSync(_a0 types.RequestProcessProposal) (*types.ResponseProcessProposal, error) {
	ret := _m.Called(_a0)
...
// MockAppConnConsensus_ProcessProposalSync_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ProcessProposalSync'
type MockAppConnConsensus_ProcessProposalSync_Call struct {
	*mock.Call
}

// ProcessProposalSync is a helper method to define mock.On call
//   - _a0 types.RequestProcessProposal
func (_e *MockAppConnConsensus_Expecter) ProcessProposalSync(_a0 interface{}) *MockAppConnConsensus_ProcessProposalSync_Call {
	return &MockAppConnConsensus_ProcessProposalSync_Call{Call: _e.mock.On("ProcessProposalSync", _a0)}
}

func (_c *MockAppConnConsensus_ProcessProposalSync_Call) Run(run func(_a0 types.RequestProcessProposal)) *MockAppConnConsensus_ProcessProposalSync_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockAppConnConsensus_ProcessProposalSync_Call) Return(_a0 *types.ResponseProcessProposal, _a1 error) *MockAppConnConsensus_ProcessProposalSync_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAppConnConsensus_ProcessProposalSync_Call) RunAndReturn(run func(types.RequestProcessProposal) (*types.ResponseProcessProposal, error)) *MockAppConnConsensus_ProcessProposalSync_Call {
	_c.Call.Return(run)
	return _c
}
