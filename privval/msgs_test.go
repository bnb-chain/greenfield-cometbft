...
func exampleReveal() *tmproto.Reveal {
	return &tmproto.Reveal{
		Height:    3,
		Signature: []byte("it's a signature"),
	}
}
...
func TestPrivvalVectors(t *testing.T) {
	...
	testCases := []struct {
		...
		{"Reveal Response with error", &privproto.SignedRevealResponse{Reveal: tmproto.Reveal{}, Error: remoteError}, "42140a0012100801120c697427732061206572726f72"},
	}
